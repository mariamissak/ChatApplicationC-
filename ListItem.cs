...
namespace ChatApplication
{
    public partial class ListItem : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            while(dr.Read())
            {
                MainForm.mainUser.ChatRoomsList.At(chatRoomPos).GetMessageStack().Push(new Message(Convert.ToInt64(dr[0].ToString()), Convert.ToInt64(dr[1].ToString()), dr[3].ToString(),Convert.ToInt64(dr[2].ToString())));
            }
